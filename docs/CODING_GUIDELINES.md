...
_This of course does not apply to this project, you must review your own Pull Requests._
...
_Reviewers can refer to these as **CG{n}** in pull request comments, where {n} is the number of the rule_
...
4. **ALWAYS DO TEST DRIVEN DEVELOPMENT (TDD)**  
   _This rule does not apply to this project (unless of course you want to MAXIMALLY OVERDELIVER)_
